...
<html>
  ...
  <body>
    ...
    <h2>Product Engineer <br/> Full-Stack Software Engineer <br/> Dev-Ops <br/> Multimedia Designer (UX|UI , Visual Communication | Graphic Design | Basic Motion Design))</h2>
